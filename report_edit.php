...
<body>
	...
	<div style="padding:0 10px;" id="report">
		...
		<div>
			<form method="POST" action="report_edit_action.php" enctype="multipart/form-data">
				<input type="text" id="mrid" name="mrid" value="<?= $_GET['id'] ?>" hidden>

				<h3>Edit treatment provided </h3>
				<table>
					<tr>
						<th width="20%">Treatment</th>
						<td colspan="3" width="80%">
							<?php
								echo '<input type="text" name="treatment" value="' .
								$treatment . '" disabled>';
							?>
						</td>
					</tr>
					...
					<tr>
						<td colspan="4">
							<textarea rows="4" name="remark" cols="35" required>
                        		<?php echo $remark; ?>
                    		</textarea>
						</td>
					</tr>
