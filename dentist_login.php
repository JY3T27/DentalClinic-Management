...
<body>
    ...
    <div class="row">
        ...
        <?php
            echo '<p align="center">Welcome: <mark><i>' . $_SESSION["dentistIc"] . '</i></mark><p>';
        ?>
        <?php
        } else {
        ?> 
            <form action="dentist_login_action.php" method="post" id="login">
                <div class="imgcontainer">
                    <img src="images/profile_icon.jpg" alt="Avatar" class="avatar">
                </div>

                <div class="container">
                    <label for="pIc"><b>Dentist Ic</b></label>
                    <input type="text" placeholder="Ic No." name="dentistIc" required>
            ...
            <div class="col-news">
                ...
                <div id="registerDiv">
                    <h2>| Dentist's Registration </h2>
                    <form action="dentist_register_action.php" method="post">
