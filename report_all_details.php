            ...
            <table>
                ...
                <tr style="border: 0px; text-align: center;">
                    <td colspan="4" style="border: 0px;">
                        <?php
                        echo '<a href="report_edit.php?id=' . $row["mr_id"] . '">
			                    <input type="button" value="Edit" name="Edit"></a>
                                <a href="report_delete.php?id=' . $row["mr_id"] . '">
			                    <input type="button" value="Delete" onClick="return confirm(\'Delete?\');" name="Delete"></a>'
                        ?>
                    </td>
                </tr>
            </table>
