...
<body>
    ...
    <div class="row">
        ...
        <?php
            echo '<p align="center">Welcome: <mark><i>' . $_SESSION["nurseIc"] . '</i></mark><p>';
        ?>
        <?php
        } else {
        ?>
            <form action="nurse_login_action.php" method="post" id="login">
                <div class="imgcontainer">
                    <img src="images/profile_icon.jpg" alt="Avatar" class="avatar">
                </div>

                <div class="container">
                    <label for="pIc"><b>Nurse Ic</b></label>
                    <input type="text" placeholder="Ic No." name="nurseIc" required>
        ...
        <div class="col-news">
            ...
            <div id="registerDiv">
                <h2>| Nurse's Registration </h2>
                <form action="nurse_register_action.php" method="post">
